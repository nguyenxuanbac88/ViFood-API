...
Chuẩn hóa và kiểm chứng chức năng `Hồ Sơ Người Dùng Và Gia Đình` của ViFood-API theo flow AI4SE: bắt đầu từ Sys-docs và AGENTS, dùng Spec Kit artifacts, chọn Codex skills đúng phạm vi, thực hiện hoặc rà soát code Backend API, chạy pytest/contract checks, sau đó chờ người phát triển xác nhận và ghi evidence.
...
```text
app/routers/v1/user_profile_v1.py
app/services/v1/profile_service_v1.py
