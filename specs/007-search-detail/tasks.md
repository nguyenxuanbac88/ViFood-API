# Tasks: Tìm Kiếm Và Chi Tiết Tri Thức

**Input**: Tài liệu thiết kế từ `/specs/007-search-detail/`
...
- [ ] T001 Đọc mobile-backend contract cho search/detail.
- [ ] T002 Đọc docs Neo4j/data ownership.
- [ ] T003 Chọn skills: `vifood-kg-linking-check`, `vifood-contract-sync-check`, `vifood-ai4se-evidence-log`.

## Phase 2: Foundation Review

**Goal**: Xác định router/service/repository/schema/test bị ảnh hưởng và ranh giới kiến trúc cần giữ.

- [ ] T004 Rà soát search/detail router và repository methods.
- [ ] T005 Rà soát public result/detail schemas app đang dùng.
- [ ] T006 Rà soát query validation, limits và not_found behavior.
...
- [ ] T007 [US1] Kiểm tra search valid/empty/invalid query.
- [ ] T008 [US1] Kiểm tra detail mapping từ graph sang public schema.
- [ ] T009 [US2] Kiểm tra no raw graph/debug payload.
- [ ] T010 [US2] Kiểm tra contract sync với iOS DTO khi response thay đổi.
