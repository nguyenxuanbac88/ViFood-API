...
**Input**: Tài liệu thiết kế từ `/specs/006-scan-history/`
...
- [ ] T001 Đọc docs history/data ownership và API contract history.
- [ ] T002 Đọc `ViFood-API/AGENTS.md` về MongoDB history ownership.
- [ ] T003 Chọn skills: `vifood-verify-scan-history`, `vifood-contract-sync-check`, `vifood-ai4se-evidence-log`.

## Phase 2: Foundation Review

**Goal**: Xác định router/service/repository/schema/test bị ảnh hưởng và ranh giới kiến trúc cần giữ.

- [ ] T004 Rà soát history model/repository/service.
- [ ] T005 Rà soát public list/detail response.
- [ ] T006 Rà soát queries bắt buộc scope theo current user.
...
- [ ] T007 [US1] Kiểm tra save success sau Builder/S3 success.
- [ ] T008 [US1] Kiểm tra failure path không tạo success history.
- [ ] T009 [US2] Kiểm tra list/detail theo user và cross-user isolation.
- [ ] T010 [US2] Kiểm tra không lưu ảnh base64 đầy đủ.
