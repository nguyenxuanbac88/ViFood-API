# Tasks: Danh Mục Tri Thức Public

**Input**: Tài liệu thiết kế từ `/specs/003-knowledge-catalog/`
...
- [ ] T001 Đọc docs data model, component Backend API và Knowledge Core.
- [ ] T002 Đối chiếu API public catalog/search/detail trong Sys-docs.
- [ ] T003 Chọn skills: `vifood-implement-api-change`, `vifood-kg-linking-check`, `vifood-contract-sync-check`, `vifood-ai4se-evidence-log`.

## Phase 2: Foundation Review

**Goal**: Xác định router/service/repository/schema/test bị ảnh hưởng và ranh giới kiến trúc cần giữ.

- [ ] T004 Liệt kê router/service/repository phục vụ danh mục tri thức.
- [ ] T005 Rà soát schema list/detail public.
- [ ] T006 Rà soát không trả raw Neo4j/provenance/debug.
...
- [ ] T007 [US1] Kiểm tra list endpoint cho từng nhóm tri thức.
- [ ] T008 [US1] Kiểm tra detail mapping và not_found.
- [ ] T009 [US2] Kiểm tra quyền/giới hạn của write/admin endpoint nếu có.
