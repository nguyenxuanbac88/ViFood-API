...
Chuẩn hóa và kiểm chứng chức năng `Danh Mục Tri Thức Public` của ViFood-API theo flow AI4SE: bắt đầu từ Sys-docs và AGENTS, dùng Spec Kit artifacts, chọn Codex skills đúng phạm vi, thực hiện hoặc rà soát code Backend API, chạy pytest/contract checks, sau đó chờ người phát triển xác nhận và ghi evidence.
...
```text
app/routers/v1
app/services/v1/search_service_v1.py
app/repositories
app/schemas
tests/test_knowledge_section_templates.py
tests/test_search_service_v1.py
```
